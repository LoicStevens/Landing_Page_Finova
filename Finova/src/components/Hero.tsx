  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 items-center h-full max-w-7xl mx-auto px-6">
        ...
        {/* LEFT SIDE – TEXT */}
        <div className="space-y-6 animate-[finova-fade-up_1.2s_ease-out_forwards] text-center md:text-left">

          <p className="text-[#4EF2FF] font-semibold text-base md:text-lg tracking-wide">
            FINOVA CAPITAL
          </p>
          ...
          <p className="text-gray-300 text-base md:text-xl max-w-xl mx-auto md:mx-0">
            Hedge Fund • Trading Automation <br />
            • Quant Intelligence • Financial Growth Strategy
          </p>

          <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center md:justify-start">
            <button className="px-7 py-3 rounded-full text-base md:text-lg font-semibold
                bg-[#4EF2FF] text-black shadow-lg shadow-[#4EF2FF]/30
                hover:shadow-[#4EF2FF]/50 transition">
              Get Started
            </button>

            <button className="px-7 py-3 rounded-full text-base md:text-lg font-semibold border
